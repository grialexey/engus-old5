...
var Card=function(e){this.init(e)};Card.prototype.init=function(e){this.cacheElements(e),this.bindEvents(),this.isRegisteredUserOwned=this.$el.is(".m-user-owned"),this.isToRepeat=this.$content.is(".m-to-repeat"),this.isOpened=!1},Card.prototype.destroy=function(){this.unbindEvents(),this.$el.remove()},Card.prototype.cacheElements=function(e){this.$el=e,this.$infoline=this.$el.find(".card__infoline"),this.$infoMenu=this.$el.find(".card__infomenu"),this.$editControls=this.$el.find(".card__controls--edit"),this.$levelChangeControls=this.$el.find(".card__controls--level-change"),this.$fullOverlay=this.$el.find(".card__overlay.m-full"),this.$nextRepeatTimeOverlay=this.$el.find(".card__overlay.m-next-repeat"),this.$rightOverlay=this.$el.find(".card__overlay.m-right"),this.$leftOverlay=this.$el.find(".card__overlay.m-left"),this.$content=this.$el.find("> .card__content"),this.$back=this.$content.find(".card__back"),this.$front=this.$content.find(".card__front"),this.frontText=this.$front.find(".card__front-word").text(),this.$frontContent=this.$content.find(".card__front > *"),this.$image=this.$content.find(".card__image"),this.$example=this.$content.find(".card__example"),this.$deleteForm=this.$el.find(".card__form--delete"),this.$copyForm=this.$el.find(".card__form--copy"),this.$editForm=this.$el.find(".card__form--update"),this.$levelChangeForm=this.$el.find(".card__form--level"),this.$editButton=this.$el.find(".card__button--edit"),this.$playAudioBtn=this.$el.find(".card__front-pron.with-audio"),this.$audio=this.$el.find(".card__audio"),this.$editForm.$exampleTextArea=this.$editForm.find(".card__form-input[name=example]")},Card.prototype.bindEvents=function(){this.$deleteForm.on("submit",{self:this},this.deleteCardEvent),this.$copyForm.on("submit",{self:this},this.copyCardEvent),this.$editForm.on("submit",{self:this},this.updateCardEvent),this.$levelChangeForm.on("submit",{self:this},this.updateCardLevelEvent),this.$content.on("click",{self:this},this.clickOnContentEvent),this.$editButton.on("click",{self:this},this.clickOnEditButtonEvent),this.$playAudioBtn.on("click",{self:this},this.playAudioEvent),this.$rightOverlay.on("click",{self:this},this.clickRightOverlayEvent),this.$leftOverlay.on("click",{self:this},this.clickLeftOverlayEvent),this.$nextRepeatTimeOverlay.on("click",{self:this},this.clickNextRepeatTimeOverlay),$(document).on("click",{self:this},this.clickOutsideEvent)},Card.prototype.unbindEvents=function(){this.$deleteForm.off("submit",this.deleteCardEvent),this.$editForm.off("submit",this.updateCardEvent),this.$levelChangeForm.off("submit",this.updateCardLevelEvent),this.$content.off("click",this.clickOnContentEvent),this.$editButton.off("click",this.clickOnEditButtonEvent),this.$playAudioBtn.off("click",this.playAudioEvent),this.$rightOverlay.off("click",this.clickRightOverlayEvent),this.$leftOverlay.off("click",this.clickLeftOverlayEvent),this.$nextRepeatTimeOverlay.off("click",this.clickNextRepeatTimeOverlay)},Card.prototype.isEditable=function(){return this.$content.is(".editable")},Card.prototype.isDefaultEditable=function(){return this.$el.is(".m-default-editable")},Card.prototype.levelUp=function(){this.$content.removeClass("m-to-repeat")},Card.prototype.levelDown=function(){this.$content.addClass("m-to-repeat")},Card.prototype.playAudio=function(){if(this.$audio.length)this.$audio[0].play();else if("speechSynthesis"in window){var e=new SpeechSynthesisUtterance(this.frontText);e.voiceURI="native",e.lang="en-US",window.speechSynthesis.speak(e)}},Card.prototype.playAudioEvent=function(e){var t=e.data.self;e.stopPropagation(),t.playAudio()},Card.prototype.clickOnContentEvent=function(e){var t=e.data.self;t.isEditable()&&t.toggleControlsMenu()},Card.prototype.clickRightOverlayEvent=function(e){var t=e.data.self;t.normalMode(),t.playAudio(),t.$rightOverlay.removeClass("m-active"),t.isToRepeat&&setTimeout(function(){t.$levelChangeControls.slideDown(200),t.isOpened=!0},350)},Card.prototype.clickLeftOverlayEvent=function(e){var t=e.data.self;t.normalMode(),t.playAudio(),t.$leftOverlay.removeClass("m-active"),t.isToRepeat&&setTimeout(function(){t.$levelChangeControls.slideDown(200),t.isOpened=!0},550)},Card.prototype.clickNextRepeatTimeOverlay=function(e){var t=e.data.self;t.$nextRepeatTimeOverlay.addClass("m-hide")},Card.prototype.toggleControlsMenu=function(){this.isOpened=!this.$infoMenu.is(":visible"),this.$infoMenu.slideToggle(200),this.$content.show(),this.$editForm.hide(),this.$levelChangeControls.slideUp(100)},Card.prototype.closeControlsMenu=function(){this.isOpened=!1,this.$infoMenu.slideUp(100),this.$content.show(),this.$editForm.hide(),this.$levelChangeControls.slideUp(100)},Card.prototype.clickOutsideEvent=function(e){var t=e.data.self,i=$(e.target);t.isOpened&&!t.$el.is(i)&&!t.$el.has(i).length>0&&t.closeControlsMenu()},Card.prototype.clickOnEditButtonEvent=function(e){var t=e.data.self;t.openEditForm()},Card.prototype.openEditForm=function(){this.isOpened=!0,this.$content.hide(),this.$infoline.hide(),this.$infoMenu.hide(),this.$editForm.show()},Card.prototype.closeEditForm=function(){this.$editForm.hide(),this.$content.show(),this.$infoline.hide(),this.$infoMenu.hide()},Card.prototype.normalMode=function(){this.$rightOverlay.removeClass("m-active"),this.$leftOverlay.removeClass("m-active"),this.$nextRepeatTimeOverlay.removeClass("m-active"),this.$frontContent.removeClass("m-hide"),this.$back.removeClass("m-hide"),this.$example.removeClass("m-hide"),this.$image.removeClass("m-hide"),this.isDefaultEditable()&&this.$content.addClass("editable")},Card.prototype.repeatRightMode=function(){this.$back.addClass("m-hide"),this.$frontContent.removeClass("m-hide"),this.$example.addClass("m-hide"),this.$image.addClass("m-hide"),this.$content.removeClass("editable"),this.$nextRepeatTimeOverlay.removeClass("m-active"),this.$leftOverlay.removeClass("m-active"),this.$rightOverlay.addClass("m-active")},Card.prototype.repeatLeftMode=function(){this.$frontContent.addClass("m-hide"),this.$back.removeClass("m-hide"),this.$example.addClass("m-hide"),this.$image.addClass("m-hide"),this.$content.removeClass("editable"),this.$nextRepeatTimeOverlay.removeClass("m-active"),this.$rightOverlay.removeClass("m-active"),this.$leftOverlay.addClass("m-active")},Card.prototype.deleteCardEvent=function(e){e.preventDefault();var t=e.data.self;t.$el.hide(),$.ajax({url:t.$deleteForm.attr("action"),method:"post",data:t.$deleteForm.serialize()}).done(function(e){$(".header__menu-repeat-count").text(e.cards_to_repeat_count),t.$el.remove()}).error(function(){t.$el.show(),t.$fullOverlay.addClass("m-active m-error").text("Ошибка при удалении"),setTimeout(function(){t.$fullOverlay.removeClass("m-active m-error").text("")},1500)})},Card.prototype.copyCardEvent=function(e){e.preventDefault();var t=e.data.self;t.$fullOverlay.addClass("m-active"),$.ajax({url:t.$copyForm.attr("action"),method:"post",data:t.$copyForm.serialize()}).done(function(e){$(".header__menu-repeat-count").text(e.cards_to_repeat_count),t.$fullOverlay.text("Скопирована"),setTimeout(function(){t.$fullOverlay.removeClass("m-active").text("")},1500),t.closeControlsMenu(),t.$infoMenu.remove(),t.$content.removeClass("editable"),t.$el.removeClass(".m-default-editable")}).error(function(){t.$fullOverlay.addClass("m-active m-error").text("Ошибка при копировании"),setTimeout(function(){t.$fullOverlay.removeClass("m-active m-error").text("")},1500)})},Card.prototype.updateCardLevelEvent=function(e){e.preventDefault();var t=e.data.self,i=$(this),a=i.find("input[name=level]").val();t.$levelChangeControls.slideUp(100),t.isOpened=!1,"up"==a?t.levelUp():"down"==a&&t.levelDown(),t.isRegisteredUserOwned&&(t.$fullOverlay.addClass("m-active"),t.updateCardAjax(i))},Card.prototype.updateCardEvent=function(e){e.preventDefault();var t=e.data.self,i=$(this);t.$fullOverlay.addClass("m-active"),t.updateCardAjax(i)},Card.prototype.updateCardAjax=function(e){var t=this,i=new FormData(e[0]);$.ajax({url:e.attr("action"),method:e.attr("method"),data:i,cache:!1,contentType:!1,processData:!1}).done(function(e){$(".header__menu-repeat-count").text(e.cards_to_repeat_count);var i=$(e.card);i.insertAfter(t.$el),t.destroy(),t.init(i)}).error(function(){e.show(),t.$fullOverlay.addClass("m-active m-error").text("Ошибка при сохранении"),setTimeout(function(){t.$fullOverlay.removeClass("m-active m-error").text("")},1500)})};
var CardList=function(t){this.cardsToRepeatCount=0,this.$wrapper=t,this.$fullOverlay=this.$wrapper.find(".card-list__overlay"),this.$content=this.$wrapper.find(".card-list__content"),this.$modeSwitcher=$(".card-list__modeswitch"),this.$filterSwitcher=$(".card-list__filter-list"),this.$filterSwitcherLinks=this.$filterSwitcher.find(".card-list__filter-list-item-link"),this.$toLearnCardsCount=this.$filterSwitcherLinks.filter(".m-to-learn").find(".card-list__filter-list-item-count"),this.$newCardsCount=this.$filterSwitcherLinks.filter(".m-new ").find(".card-list__filter-list-item-count"),this.$toRepeatCardsCount=this.$filterSwitcherLinks.filter(".m-to-repeat").find(".card-list__filter-list-item-count"),this.$learnedCardsCount=this.$filterSwitcherLinks.filter(".m-learned").find(".card-list__filter-list-item-count"),this.$modeSwitcher.$items=this.$modeSwitcher.find(".card-list__modeswitch-item"),this.$pages=this.$content.find(".paginator__link"),this.cards=this.getCards(),this.bindEvents()};CardList.prototype.getModeInUrl=function(){var t=new Url;return t.query.mode},CardList.prototype.setModeInUrl=function(t){var e=new Url;null===t?(delete e.query.mode,window.history.pushState({},"",e.toString())):(e.query.mode=t,window.history.pushState({},"",e.toString()))},CardList.prototype.bindEvents=function(){this.$modeSwitcher.$items.on("click",{self:this},this.switchModeEvent)},CardList.prototype.getCards=function(){var t=[],e=this.$content.find(".card");return e.each(function(){t.push(new Card($(this)))}),t},CardList.prototype.switchModeEvent=function(t){var e=t.data.self,r=$(this).data("mode");switch(e.$modeSwitcher.$items.removeClass("m-active"),r){case"normal":e.setNormalMode(e.cards),e.$modeSwitcher.removeClass("m-normal m-repeat m-repeat-right m-repeat-left"),e.$modeSwitcher.addClass("m-normal"),e.$modeSwitcher.$items.filter(".m-normal").addClass("m-active"),e.setModeInUrl(null);break;case"repeat":e.$modeSwitcher.is(".m-repeat-right")?(e.setRepeatLeftMode(this.cards),e.$modeSwitcher.removeClass("m-normal m-repeat m-repeat-right m-repeat-left"),e.$modeSwitcher.addClass("m-repeat m-repeat-left"),e.$modeSwitcher.$items.filter(".m-repeat").addClass("m-active").removeClass("m-repeat-right").addClass("m-repeat-left"),e.setModeInUrl("repeat-left")):(e.setRepeatRightMode(this.cards),e.$modeSwitcher.removeClass("m-normal m-repeat m-repeat-right m-repeat-left"),e.$modeSwitcher.addClass("m-repeat m-repeat-right"),e.$modeSwitcher.$items.filter(".m-repeat").addClass("m-active").removeClass("m-repeat-left").addClass("m-repeat-right"),e.setModeInUrl("repeat-right"))}e.changePagesUrls()},CardList.prototype.changePagesUrls=function(){var t=this;this.$pages.each(function(){var e=new Url($(this).attr("href")),r=(new Url,t.getModeInUrl());r?e.query.mode=r:delete e.query.mode,$(this).attr("href",e.toString())})},CardList.prototype.setNormalMode=function(){this.cardsToRepeatCount=0,this.cards.forEach(function(t){t.normalMode()})},CardList.prototype.setRepeatRightMode=function(){this.cardsToRepeatCount=this.cards.length,this.randomize(),this.cards.forEach(function(t){t.repeatRightMode()})},CardList.prototype.setRepeatLeftMode=function(){this.cardsToRepeatCount=this.cards.length,this.randomize(),this.cards.forEach(function(t){t.repeatLeftMode()})},CardList.prototype.randomize=function(){var t=this;this.cards.sort(function(){return Math.round(Math.random())-.5}).forEach(function(e){e.$el.detach().appendTo(t.$content.find(".card-list__list"))})};
var CardCreator=function(e){this.init(e)};CardCreator.prototype.init=function(e){this.cacheElements(e),this.bindEvents(),this.deffered=$.Deferred()},CardCreator.prototype.getDeferred=function(){return this.deffered},CardCreator.prototype.cacheElements=function(e){this.$el=e,this.$form=e.find(".card__form--create"),this.$el.find(".card__overlay:not(.m-full)").remove(),this.$fullOverlay=this.$el.find(".card__overlay.m-full")},CardCreator.prototype.bindEvents=function(){this.$form.on("submit",{self:this},this.createCardEvent)},CardCreator.prototype.unbindEvents=function(){this.$form.on("submit",this.createCardEvent)},CardCreator.prototype.createCardEvent=function(e){e.preventDefault();var t=e.data.self,r=$(this);t.$fullOverlay.addClass("m-active"),$.ajax({url:r.attr("action"),method:r.attr("method"),data:new FormData(r[0]),cache:!1,contentType:!1,processData:!1}).done(function(e){t.unbindEvents(),t.$el.trigger("created",[e]),t.$el.remove()}).error(function(){r.show(),t.$fullOverlay.addClass("m-active m-error").text("Ошибка при добавлении"),setTimeout(function(){t.$fullOverlay.removeClass("m-active m-error").text("")},1500)})};
var CardQuickCreator=function(){this.init()};CardQuickCreator.prototype.init=function(){this.loading=!1,this.cacheElements(),this.bindEvents()},CardQuickCreator.prototype.cacheElements=function(){this.$template=$(".header").find(".card.m-creator"),this.$button=$(".header__menu-link--add"),this.$pageOverlay=$(".content__overlay"),this.$cardCreator=this.createCardCreator()},CardQuickCreator.prototype.bindEvents=function(){this.$button.on("click",{self:this},this.clickButtonEvent),$(document).on("click",{self:this},this.clickOutsideEvent)},CardQuickCreator.prototype.createCardCreator=function(){var t=this.$template.clone();return t.removeClass("m-hide").addClass("m-quick-creator").hide(),t.find(".card__overlay:not(.m-full)").remove(),t.$fullOverlay=t.find(".card__overlay"),t.prependTo(".header__menu"),t.find(".card__form--create").on("submit",{self:this},this.createEvent),t},CardQuickCreator.prototype.clickOutsideEvent=function(t){var e=$(t.target),a=t.data.self;a.$cardCreator.is(e)||a.$cardCreator.has(e).length||e.is(a.$button)||(a.$button.removeClass("active"),a.$pageOverlay.fadeOut(150),a.$cardCreator.fadeOut(150))},CardQuickCreator.prototype.clickButtonEvent=function(t){var e=t.data.self;e.loading||(e.$button.is(".active")?e.close():e.open())},CardQuickCreator.prototype.open=function(){this.$button.addClass("active"),this.$pageOverlay.fadeIn(150),this.$cardCreator.fadeIn(150).find("input[type=text]").first().focus()},CardQuickCreator.prototype.close=function(){this.$button.removeClass("active"),this.$pageOverlay.fadeOut(150),this.$cardCreator.fadeOut(150)},CardQuickCreator.prototype.createEvent=function(t){t.preventDefault();var e=t.data.self,a=$(this);e.$cardCreator.$fullOverlay.addClass("m-active"),e.loading=!0,$.ajax({url:a.attr("action"),method:a.attr("method"),data:new FormData(a[0]),cache:!1,contentType:!1,processData:!1}).done(function(t){$(".header__menu-repeat-count").text(t.cards_to_repeat_count),e.loading=!1,e.$button.removeClass("active"),e.$pageOverlay.fadeOut(150),e.$cardCreator.remove(),e.$cardCreator=e.createCardCreator()}).error(function(){e.loading=!1,e.$cardCreator.$fullOverlay.addClass("m-active m-error").text("Ошибка при добавлении"),setTimeout(function(){e.$cardCreator.$fullOverlay.removeClass("m-active m-error").text("")},1500)})};
$(document).ready(function(){new CardList($(".card-list"));$(".card-list .card.m-creator").each(function(){var t=new CardCreator($(this));t.$el.on("created",function(t,e){window.location.hash="#card"+e.id,window.location.reload()})}),new CardQuickCreator,setInterval(function(){$.get("/cards/api/my-cards-count/").done(function(t){$(".header__menu-repeat-count").text(t.cards_to_repeat_count)})},18e4);var t=$(".article");t.length>0&&t.on("submit",".article__copy-cards-form",function(t){t.preventDefault();var e=$(this),a=e.find(".article__copy-btn");a.removeClass("m-active"),a.attr("disabled","disabled"),$.ajax({url:e.attr("action"),method:e.attr("method"),data:e.serialize()}).done(function(t){$(".header__menu-repeat-count").text(t.cards_to_repeat_count),a.html("Все&nbsp;карточки добавлены в&nbsp;Мои&nbsp;карточки")}).error(function(){var t=a.text();a.addClass("m-active"),a.text("Ошибка при добавлении"),window.setTimeout(function(){a.removeAttr("disabled"),a.text(t)},1500)})})});